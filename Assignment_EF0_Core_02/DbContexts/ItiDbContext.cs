...
using Assignment_EF0_Core_02.Models;
...
namespace Assignment_ef01.DbContexts
{
    internal class ItiDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CourseInst>().HasKey(ci => new { ci.Inst_ID, ci.Course_ID });
            modelBuilder.Entity<StudCourse>().HasKey(sc => new { sc.Stud_ID, sc.Course_ID });
